...
export class EffectParameterPage extends Component {
  private _device: LaunchControlDevice
...
export const makeEffectParameterPage = (template: number) => (device: LaunchControlDevice) => new EffectParameterPage(device, template)
