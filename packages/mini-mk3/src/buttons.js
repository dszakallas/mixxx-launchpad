...
module.exports = {
  ...
  up:      { status: 0xB0, midino: 0x5B, name: 'up' },
  down:    { status: 0xB0, midino: 0x5C, name: 'down' },
  left:    { status: 0xB0, midino: 0x5D, name: 'left' },
  right:   { status: 0xB0, midino: 0x5E, name: 'right' },
  session: { status: 0xB0, midino: 0x5F, name: 'session' },
  user1:   { status: 0xB0, midino: 0x60, name: 'user1' },
  user2:   { status: 0xB0, midino: 0x61, name: 'user2' },
  mixer:   { status: 0xB0, midino: 0x62, name: 'mixer' },
  vol:     { status: 0xB0, midino: 0x59, name: 'vol' },
  pan:     { status: 0xB0, midino: 0x4F, name: 'pan' },
  snda:    { status: 0xB0, midino: 0x45, name: 'snda' },
  sndb:    { status: 0xB0, midino: 0x3B, name: 'sndb' },
  stop:    { status: 0xB0, midino: 0x31, name: 'stop' },
  trkon:   { status: 0xB0, midino: 0x27, name: 'trkon' },
  solo:    { status: 0xB0, midino: 0x1D, name: 'solo' },
  arm:     { status: 0xB0, midino: 0x13, name: 'arm' },
