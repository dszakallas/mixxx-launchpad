import { channelControlDefs, setValue, Component, ControlComponent, MidiComponent, MidiControlDef, MidiDevice, MidiMessage, absoluteNonLin, sendShortMsg, sendSysexMsg } from "@mixxx-launchpad/mixxx"
...
const asNote = ({ midino, status, name }: MidiControlDef) => ({ midino, status: status & (~32 & 0xFF), name })
