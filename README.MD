...
## Features ✨
 ...
 - utilize presetes with multiple sizes and features, change between them with ease 🦄
...
To build you need to have make, a recent Node (>=4) and npm.

First clone the repo and install the package dependencies with npm:
